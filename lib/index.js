...
var MetalSmithLoader = function MetalSmithLoader(opts) {
  ...
  if (!opts.destination) throw new Error('No destination param provided for the output directory'); //if (!opts.assets) throw new Error('No assets param provided for the assets directory')
